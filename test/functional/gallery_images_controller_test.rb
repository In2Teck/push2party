...
class GalleryImagesControllerTest < ActionController::TestCase
  ...
  test "should create gallery_image" do
    assert_difference('GalleryImage.count') do
      post :create, gallery_image: { description: @gallery_image.description, gallery_id: @gallery_image.gallery_id, image_url: @gallery_image.image_url, visible: @gallery_image.visible }
    end
  ...
  test "should update gallery_image" do
    put :update, id: @gallery_image, gallery_image: { description: @gallery_image.description, gallery_id: @gallery_image.gallery_id, image_url: @gallery_image.image_url, visible: @gallery_image.visible }
    assert_redirected_to gallery_image_path(assigns(:gallery_image))
  end
